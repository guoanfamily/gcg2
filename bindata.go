...
func apiGen_apiGoTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "api/gen_api.go.tmpl", size: 2530, mode: os.FileMode(438), modTime: time.Unix(1648085664, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
